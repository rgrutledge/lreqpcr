...
public class LreWindowSelector {
     ...
     * 
     * As of 0.8.5 inclusion of an Emax threshold (>40%) was found to greatly 
     * increase the accuracy of LRE window selection. <p>
     *
...
//Dislike doing this, but it would good to alert the user that the min Fc is too high
//However, generating an error dialog is not an option due to the potentially large numbers of profiles being processed
//Subsequently, user warning of too high min Fc is generated by the Selection Parameter Panel
                profile.setHasAnLreWindowBeenFound(false);
                processFailedProfile(profile);
                return;
            }
