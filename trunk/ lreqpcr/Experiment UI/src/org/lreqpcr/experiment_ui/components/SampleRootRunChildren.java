 ...
 * @author Bob Rutledge
 */
public class SampleRootRunChildren extends LreObjectChildren {
     ...
     */
    public SampleRootRunChildren(ExplorerManager mgr, DatabaseServices db, List<? extends Run> runList,
    ...
    protected Node[] createNodes(LreObject lreObject) {
        ...
        LreNode node = new LreNode(new SampleRunChildren(mgr, db, avSamplePrfList, nodeActionFactory, nodeLabelFactory),
