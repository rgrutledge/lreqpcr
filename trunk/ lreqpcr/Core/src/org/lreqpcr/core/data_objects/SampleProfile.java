 ...
 * output is the number of target molecules (No) that is derived from the
 * average Fo using the optical calibration factor derived from the same assay
 * setup used to conduct the amplification.
 *
 * @author Bob Rutledge
 */
...
//the No values via calling updateSampleProfile()
    ...
    /**
     * Target quantity should only be modified by implementations of
     * SampleProfile.
     *
     * @param no target quantity expressed in molecules calculated using the
     * LRE-derived Emax.
     * @param noEmax100 target quantity expressed in molecules calculated using
     * Emax fixed to 100%
     */
