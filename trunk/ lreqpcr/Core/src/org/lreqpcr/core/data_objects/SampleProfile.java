...
//the number of target molecules via calling updateSampleProfile()
    ...
    /**
     * Provides the number of target molecules normalized to the profile Fmax 
     * relative to the Run's average Fmax. Due to fact that target quantity is 
     ...
     * determination of the number of target molecules assumes that fluorescence intensity 
     * is equal across all wells within a Run. 
     * <p>
