 ...
 * @author Bob Rutledge
 */
public class ProfileInitializer {//Deactivated****************************************************************************
...
//    }
     ...
     * editing of the cycles within the amplification profile. Note that no additional analysis is
...
//        Cycle runner = prfSum.getLreWindowStartCycle().getPrevCycle(); //First cycle to be included in the average
//        try {
