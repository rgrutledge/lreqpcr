 ...
 * @author Bob Rutledge
 */
public class AvCalProfileNodesWithCalProfileChildren extends LreObjectChildren{

    public AvCalProfileNodesWithCalProfileChildren(ExplorerManager mgr, DatabaseServices db,
            List<AverageCalibrationProfile> avCalibrationProfileList,
            LreActionFactory actionFactory, LabelFactory labelFactory) {
        super(mgr, db, avCalibrationProfileList, actionFactory, labelFactory);
    }
