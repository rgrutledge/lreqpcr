 ...
 * @author Bob Rutledge
 */
public class RunNodesWithAvCalChildren extends LreObjectChildren {

    /**
     * Generates AverageCalibration Profile nodes for a Run.
     * 
     ...
     */
    public RunNodesWithAvCalChildren(ExplorerManager mgr, DatabaseServices db, List<? extends Run> runList,
    ...
    protected Node[] createNodes(LreObject lreObject) {
        ...
        for (AverageProfile avPrf : avProfileList){
            ...
            avCalPrfList.add(avCalPrf);
        }
        LreNode node = new LreNode(new AvCalProfileNodesWithCalProfileChildren(mgr, db, avCalPrfList, nodeActionFactory, nodeLabelFactory),
