...
/**
 * A calibration profile which is generated by amplification of a known quantity of
 * lambda gDNA. Calibration profiles are used for optical calibration from
 * which an optical calibration factors (OCF) is generated. Calculating OCF requires
 * that the mass of lambda be provided. 
 *
 * @author Bob Rutledge
 */
public class CalibrationProfile extends Profile {
    ...
    /**
     *  Target standedness
     * is set to double stranded by default
     */
