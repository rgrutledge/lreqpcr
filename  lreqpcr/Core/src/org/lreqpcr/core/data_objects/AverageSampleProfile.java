...
//    }
    ...
    /**
     * Recalculates No. If ReplicateProfile average No is less than 10 N, the
    ...
    /**
     * Determines if the AverageProfile is valid, due to the fact that if the
     * number of target molecules is less than 10, the AverageProfile can be
     * distorted due to profile scattering caused by Poison Distribution. If so,
     * the average No of the AverageProfile is set to the average of the
     * ReplicateProfile No values. Calling this function will also update the
     * profile.
     *
     ...
     * distorted due to replicate profile scattering, and thus must be
     * invalidated. If so, the average No for the AverageProfile is then
     * determined by averaging the No values from each of the ReplicateProfiles.
     ...
     * replicate profiles and the profile will be set to "No LRE window has been
     * found". return boolean has no function
     */
