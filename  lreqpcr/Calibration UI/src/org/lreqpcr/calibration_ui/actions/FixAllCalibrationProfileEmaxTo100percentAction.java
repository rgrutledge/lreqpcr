 ...
 * @author Bob Rutledge
 */
public class FixAllCalibrationProfileEmaxTo100percentAction extends AbstractAction {
    ...
    public FixAllCalibrationProfileEmaxTo100percentAction(ExplorerManager mgr) {
        this.mgr = mgr;
        putValue(NAME, "Fix all Profiles' Emax to 100%");
    }
