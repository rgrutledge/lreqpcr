 ...
 * @author Bob Rutledge
 */
public class AvSampleProfileNode extends LreNode implements ExplorerManager.Provider {
...
//    private DatabaseServices db;//The DB holding the LRE object
     ...
     */
    public AvSampleProfileNode(Children children, Lookup lookup, Action[] nodeActions) {
        super(children, lookup, nodeActions);
//        actions = nodeActions;
    }
...
//        if (parentNode != null) {
//            AvSampleProfileChildren children = (AvSampleProfileChildren) parentNode.getChildren();
//            children.refreshRunNodeLabel(this);
//        }
//    }
