...
public class LreObjectChildren extends Children.Keys<LreObject> {
     ...
     * @param db
     *     the database that is being viewed
     * @param childrenObjects
     *     the list holding the children objects
     * @param actionFactory
     *     the node action factory
     * @param labelFactory
     *     the node label factory
     */
    public LreObjectChildren(
        ExplorerManager mgr, DatabaseServices db, List<? extends LreObject> childrenObjects,
     ...
     * @param db
     *     the database that is being viewed
     * @param partentLreObject
     *     the parent LRE object
     * @param actionFactory
     *     the node action factory
     * @param labelFactory
     *     the node label factory
    ...
    public LreObjectChildren(
        ExplorerManager mgr, DatabaseServices db, LreObject partentLreObject,
        LreActionFactory actionFactory, LabelFactory labelFactory)
    {
        this.mgr = mgr;
        this.db = db;
    ...
    public void addNotify() {
        ...
        ArrayList<LreObject> lreObjectArray = new ArrayList<>(lreObjectList);
